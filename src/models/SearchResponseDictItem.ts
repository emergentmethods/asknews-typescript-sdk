...
export interface SearchResponseDictItem {
     ...
     * @memberof SearchResponseDictItem
     */
    contentType?: SearchResponseDictItemContentTypeEnum | null;
    /**
     * 
     * @type {string}
     * @memberof SearchResponseDictItem
 ...
 * @export
 */
export const SearchResponseDictItemContentTypeEnum = {
    News: 'news',
    Opinion: 'opinion',
    Analysis: 'analysis',
    Review: 'review',
...
export type SearchResponseDictItemContentTypeEnum = typeof SearchResponseDictItemContentTypeEnum[keyof typeof SearchResponseDictItemContentTypeEnum];
