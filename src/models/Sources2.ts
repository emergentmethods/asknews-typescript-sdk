...
/**
 * Which data sources DeepNews should use. Can be a single source or a list. Available sources are: asknews, google, graph, wiki, x, reddit, charts, email. Defaults to ['asknews', 'google', 'wiki', 'x'].
 * @export
 * @interface Sources2
 */
