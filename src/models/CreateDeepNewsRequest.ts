...
import {
    CutoffDatetimeFromJSON,
    CutoffDatetimeFromJSONTyped,
    CutoffDatetimeToJSON,
    CutoffDatetimeToJSONTyped,
} from './CutoffDatetime';
...
export function CreateDeepNewsRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateDeepNewsRequest {
    ...
    return {
        ...
        'cutoffDatetime': json['cutoff_datetime'] == null ? undefined : CutoffDatetimeFromJSON(json['cutoff_datetime']),
    };
}
...
export function CreateDeepNewsRequestToJSONTyped(value?: CreateDeepNewsRequest | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'cutoff_datetime': CutoffDatetimeToJSON(value['cutoffDatetime']),
    };
}
