...
export interface SearchResponseDictItem1 {
     ...
     * @memberof SearchResponseDictItem1
     */
    contentType?: SearchResponseDictItem1ContentTypeEnum | null;
    /**
     * 
     * @type {string}
     * @memberof SearchResponseDictItem1
 ...
 * @export
 */
export const SearchResponseDictItem1BiasEnum = {
    Political: 'Political',
    Gender: 'Gender',
    Cultural: 'Cultural',
    Age: 'Age',
 ...
 * @export
 */
export const SearchResponseDictItem1ContentTypeEnum = {
    News: 'news',
    Opinion: 'opinion',
    Analysis: 'analysis',
    Review: 'review',
    ...
    Obituary: 'obituary',
    DataJournalism: 'data_journalism'
} as const;
export type SearchResponseDictItem1ContentTypeEnum = typeof SearchResponseDictItem1ContentTypeEnum[keyof typeof SearchResponseDictItem1ContentTypeEnum];
...
export function SearchResponseDictItem1FromJSONTyped(json: any, ignoreDiscriminator: boolean): SearchResponseDictItem1 {
    ...
    return {
        ...
        'authors': json['authors'] == null ? undefined : ((json['authors'] as Array<any>).map(Author1FromJSON)),
        ...
        'crawlDate': json['crawl_date'] == null ? undefined : (new Date(json['crawl_date'])),
...
export function SearchResponseDictItem1ToJSONTyped(value?: SearchResponseDictItem1 | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'bias': value['bias'],
        'authors': value['authors'] == null ? undefined : ((value['authors'] as Array<any>).map(Author1ToJSON)),
        'full_text': value['fullText'],
        'original_language_summary': value['originalLanguageSummary'],
        'image_description': value['imageDescription'],
        'crawl_date': value['crawlDate'] == null ? undefined : ((value['crawlDate'] as any).toISOString()),
