...
export interface LiveWebSearchRequest {
    ...
    startDatetime?: Date;
    endDatetime?: Date;
    engine?: LiveWebSearchEngineEnum;
 ...
 * @export
 */
export const LiveWebSearchEngineEnum = {
    V1: 'v1',
    V15: 'v1.5'
} as const;
export type LiveWebSearchEngineEnum = typeof LiveWebSearchEngineEnum[keyof typeof LiveWebSearchEngineEnum];
