...
export class GraphApi extends runtime.BaseAPI {
     ...
     */
    async buildGraphRaw(requestParameters: BuildGraphRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GraphResponse>> {
        if (requestParameters['bodyBuildGraph'] == null) {
            throw new runtime.RequiredError(
                'bodyBuildGraph',
                'Required parameter "bodyBuildGraph" was null or undefined when calling buildGraph().'
            );
        }
     ...
     * Build a custom mega-news-knowledge graph
     */
    async buildGraph(requestParameters: BuildGraphRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GraphResponse> {
