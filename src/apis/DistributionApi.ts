...
import {
    ...
    AbcAPIErrorModel109FromJSON,
    AbcAPIErrorModel109ToJSON,
    AbcAPIErrorModel110FromJSON,
    AbcAPIErrorModel110ToJSON,
    AbcAPIErrorModel111FromJSON,
    AbcAPIErrorModel111ToJSON,
    AbcAPIErrorModel112FromJSON,
    AbcAPIErrorModel112ToJSON,
    ...
    DomainMetricsResponseFromJSON,
    DomainMetricsResponseToJSON,
    DomainMetricsTimeWindowResponseFromJSON,
    DomainMetricsTimeWindowResponseToJSON,
...
export interface GetDomainMetricsRequest {
    domainNames: Array<string>;
    startDate?: number;
    endDate?: number;
}

export interface GetDomainMetricsTimeseriesRequest {
    domainNames: Array<string>;
    startDate?: number;
    endDate?: number;
}
...
export class DistributionApi extends runtime.BaseAPI {
     ...
     */
    async getDomainMetricsRaw(requestParameters: GetDomainMetricsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DomainMetricsResponse> > {
        if (requestParameters['domainNames'] == null) {
            throw new runtime.RequiredError(
                'domainNames',
                'Required parameter "domainNames" was null or undefined when calling getDomainMetrics().'
            );
        }
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => DomainMetricsResponseFromJSON(jsonValue));
    }
     ...
     * Get raw publisher metric event counts for domains
     */
    async getDomainMetrics(requestParameters: GetDomainMetricsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<DomainMetricsResponse> {
        const response = await this.getDomainMetricsRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async getDomainMetricsTimeseriesRaw(requestParameters: GetDomainMetricsTimeseriesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DomainMetricsTimeWindowResponse> > {
        if (requestParameters['domainNames'] == null) {
            throw new runtime.RequiredError(
                'domainNames',
                'Required parameter "domainNames" was null or undefined when calling getDomainMetricsTimeseries().'
            );
        }
        ...
        const response = await this.request({
            path: `/v1/distribution/stats/metrics_timeseries`,
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => DomainMetricsTimeWindowResponseFromJSON(jsonValue));
    }
     ...
     * Get raw publisher metric event counts per day for domains
     */
    async getDomainMetricsTimeseries(requestParameters: GetDomainMetricsTimeseriesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<DomainMetricsTimeWindowResponse> {
        const response = await this.getDomainMetricsTimeseriesRaw(requestParameters, initOverrides);
        return await response.value();
    }
