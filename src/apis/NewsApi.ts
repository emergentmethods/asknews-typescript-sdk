...
import {
    ...
    DomainUrlFromJSON,
    DomainUrlToJSON,
    EndTimestampFromJSON,
    EndTimestampToJSON,
    EndTimestamp1FromJSON,
    EndTimestamp1ToJSON,
    EntityGuaranteeFromJSON,
    EntityGuaranteeToJSON,
    PageRankFromJSON,
    PageRankToJSON,
    ReverseStringGuaranteeFromJSON,
    ReverseStringGuaranteeToJSON,
    ...
    StartTimestampFromJSON,
    StartTimestampToJSON,
    StartTimestamp1FromJSON,
    StartTimestamp1ToJSON,
    StringGuaranteeFromJSON,
    StringGuaranteeToJSON,
...
export interface SearchNewsRequest {
    ...
    reportingVoice?: SearchNewsReportingVoiceEnum;
    domainUrl?: DomainUrl;
    pageRank?: PageRank;
    diversifySources?: boolean;
    strategy?: SearchNewsStrategyEnum;
    hoursBack?: number;
    stringGuarantee?: StringGuarantee;
    reverseStringGuarantee?: ReverseStringGuarantee;
    entityGuarantee?: EntityGuarantee;
}
...
export class NewsApi extends runtime.BaseAPI {
    ...
    async searchNewsRaw(requestParameters: SearchNewsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<SearchResponse>> {
        if (requestParameters['query'] == null) {
            throw new runtime.RequiredError(
                'query',
                'Required parameter "query" was null or undefined when calling searchNews().'
            );
        }
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: EntityGuaranteeToJSON(requestParameters['entityGuarantee']),
        }, initOverrides);
 ...
 * @export
 */
export const SearchNewsReportingVoiceEnum = {
    Objective: 'Objective',
...
export type SearchNewsReportingVoiceEnum = typeof SearchNewsReportingVoiceEnum[keyof typeof SearchNewsReportingVoiceEnum];
/**
 * @export
 */
