...
import {
    ...
    BadDomainUrlFromJSON,
    BadDomainUrlToJSON,
    BadDomainUrl1FromJSON,
    BadDomainUrl1ToJSON,
    DomainUrlFromJSON,
    DomainUrlToJSON,
...
export interface GetIndexCountsRequest {
    ...
    timeFilter?: GetIndexCountsTimeFilterEnum;
    categories?: Array<GetIndexCountsCategoriesEnum>;
    provocative?: GetIndexCountsProvocativeEnum;
    reportingVoice?: Array<GetIndexCountsReportingVoiceEnum>;
    badDomainUrl?: BadDomainUrl1;
    pageRank?: number;
    stringGuarantee?: Array<string>;
    stringGuaranteeOp?: GetIndexCountsStringGuaranteeOpEnum;
    reverseStringGuarantee?: Array<string>;
    entityGuarantee?: Array<string>;
    entityGuaranteeOp?: GetIndexCountsEntityGuaranteeOpEnum;
    languages?: Array<GetIndexCountsLanguagesEnum>;
    countries?: Array<string>;
    countriesBlacklist?: Array<string>;
    continents?: Array<GetIndexCountsContinentsEnum>;
...
export interface SearchNewsRequest {
    ...
    podcasts?: SearchNewsPodcastsEnum;
    pageRank?: number;
    ...
    tryCache?: SearchNewsTryCacheEnum;
    geoLat?: number;
    geoLon?: number;
    geoRadius?: number;
    geoPolygon?: string;
...
export class NewsApi extends runtime.BaseAPI {
    ...
    async getArticlesRaw(requestParameters: GetArticlesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<SearchResponseDictItem>> > {
        ...
        if (requestParameters['fullText'] != null) {
            queryParameters['full_text'] = requestParameters['fullText'];
        }
    ...
    async getIndexCountsRaw(requestParameters: GetIndexCountsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<IndexCountItem>> > {
        ...
        if (requestParameters['badDomainUrl'] != null) {
            queryParameters['bad_domain_url'] = requestParameters['badDomainUrl'];
        }
        ...
        if (requestParameters['countriesBlacklist'] != null) {
            queryParameters['countries_blacklist'] = requestParameters['countriesBlacklist'];
        }
    ...
    async searchNewsRaw(requestParameters: SearchNewsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<SearchResponse> > {
        ...
        if (requestParameters['podcasts'] != null) {
            queryParameters['podcasts'] = requestParameters['podcasts'];
        }
        ...
        if (requestParameters['reverseEntityGuarantee'] != null) {
            queryParameters['reverse_entity_guarantee'] = requestParameters['reverseEntityGuarantee'];
        }
        ...
        if (requestParameters['tryCache'] != null) {
            queryParameters['try_cache'] = requestParameters['tryCache'];
        }

        if (requestParameters['geoLat'] != null) {
            queryParameters['geo_lat'] = requestParameters['geoLat'];
        }

        if (requestParameters['geoLon'] != null) {
            queryParameters['geo_lon'] = requestParameters['geoLon'];
        }

        if (requestParameters['geoRadius'] != null) {
            queryParameters['geo_radius'] = requestParameters['geoRadius'];
        }

        if (requestParameters['geoPolygon'] != null) {
            queryParameters['geo_polygon'] = requestParameters['geoPolygon'];
        }
 ...
 * @export
 */
export const GetIndexCountsTimeFilterEnum = {
    CrawlDate: 'crawl_date',
    PubDate: 'pub_date'
} as const;
export type GetIndexCountsTimeFilterEnum = typeof GetIndexCountsTimeFilterEnum[keyof typeof GetIndexCountsTimeFilterEnum];
/**
 * @export
 */
export const GetIndexCountsCategoriesEnum = {
    All: 'All',
    Business: 'Business',
    Crime: 'Crime',
    Politics: 'Politics',
...
export type GetIndexCountsCategoriesEnum = typeof GetIndexCountsCategoriesEnum[keyof typeof GetIndexCountsCategoriesEnum];
/**
 * @export
 */
export const GetIndexCountsProvocativeEnum = {
    Unknown: 'unknown',
    Low: 'low',
    Medium: 'medium',
    High: 'high',
...
export type GetIndexCountsProvocativeEnum = typeof GetIndexCountsProvocativeEnum[keyof typeof GetIndexCountsProvocativeEnum];
/**
 * @export
 */
export const GetIndexCountsReportingVoiceEnum = {
    Objective: 'Objective',
...
export type GetIndexCountsReportingVoiceEnum = typeof GetIndexCountsReportingVoiceEnum[keyof typeof GetIndexCountsReportingVoiceEnum];
/**
 * @export
 */
export const GetIndexCountsStringGuaranteeOpEnum = {
    And: 'AND',
    Or: 'OR'
} as const;
export type GetIndexCountsStringGuaranteeOpEnum = typeof GetIndexCountsStringGuaranteeOpEnum[keyof typeof GetIndexCountsStringGuaranteeOpEnum];
/**
 * @export
 */
export const GetIndexCountsEntityGuaranteeOpEnum = {
    And: 'AND',
    Or: 'OR'
} as const;
export type GetIndexCountsEntityGuaranteeOpEnum = typeof GetIndexCountsEntityGuaranteeOpEnum[keyof typeof GetIndexCountsEntityGuaranteeOpEnum];
/**
 * @export
 */
export const GetIndexCountsLanguagesEnum = {
    Sq: 'sq',
    Ar: 'ar',
    Az: 'az',
    Ca: 'ca',
...
export type GetIndexCountsLanguagesEnum = typeof GetIndexCountsLanguagesEnum[keyof typeof GetIndexCountsLanguagesEnum];
/**
 * @export
 */
export const GetIndexCountsContinentsEnum = {
    Africa: 'Africa',
    Asia: 'Asia',
    Oceania: 'Oceania',
    Europe: 'Europe',
...
export type GetIndexCountsContinentsEnum = typeof GetIndexCountsContinentsEnum[keyof typeof GetIndexCountsContinentsEnum];
/**
 * @export
 */
export const GetIndexCountsSentimentEnum = {
    Negative: 'negative',
    Neutral: 'neutral',
    Positive: 'positive'
} as const;
export type GetIndexCountsSentimentEnum = typeof GetIndexCountsSentimentEnum[keyof typeof GetIndexCountsSentimentEnum];
/**
 * @export
 */
 ...
 * @export
 */
export const SearchNewsPodcastsEnum = {
    Include: 'include',
    Only: 'only',
    None: 'none'
} as const;
export type SearchNewsPodcastsEnum = typeof SearchNewsPodcastsEnum[keyof typeof SearchNewsPodcastsEnum];
/**
 * @export
 */
 ...
 * @export
 */
export const SearchNewsTryCacheEnum = {
    _1h: '1h',
    _6h: '6h',
    _12h: '12h',
    _24h: '24h',
...
export type SearchNewsTryCacheEnum = typeof SearchNewsTryCacheEnum[keyof typeof SearchNewsTryCacheEnum];
